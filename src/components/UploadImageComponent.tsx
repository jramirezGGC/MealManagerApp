...
const UploadImageComponent = forwardRef<
  UploadImageComponentRef,
  UploadImageComponentProps
>(
  (
    { onImageUploaded, storagePath = "uploads", startWithStoredImage = false },
    ref
  ) => {
    ...
    const uploadImageToFirebase = async (uri: string) => {
      try {
        ...
        console.error(
          "Error in uploadImageToFirebase:",
          error?.message || error
        );
      ...
      <View style={styles.content}>
        <View style={styles.headerContainer}>
          ...
          <Text style={styles.headerSubtitle}>
            Select or take a photo for your meal
          </Text>
        </View>
